                                                                    ...
                                                                    <table cellpadding="0" cellspacing="0"
                                                                        ...
                                                                        <tr>
                                                                            <td align="left"
                                                                                ...
                                                                                <p
                                                                                    style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px">
                                                                                    <strong>{{ $value['ten_san_pham'] }}</strong></p>
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                                                </td>
                                                                    ...
                                                                    <table cellpadding="0" cellspacing="0"
                                                                        ...
                                                                        <tr>
                                                                            <td align="center"
                                                                                ...
                                                                                <p
                                                                                    style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px">
                                                                                    <strong>{{ $value['so_luong'] }}</strong></p>
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                                                </td>
                                                                    ...
                                                                    <table cellpadding="0" cellspacing="0"
                                                                        ...
                                                                        <tr>
                                                                            <td align="right"
                                                                                ...
                                                                                <p
                                                                                    style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px">
                                                                                    <strong>{{ number_format($value['don_gia'], 0, '.', ',') }}</strong></p>
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                                                </td>
                                                            ...
                                                            <tr>
                                                                <td align="right" class="es-m-txt-r"
                                                                    ...
                                                                    <h3
                                                                        ...
                                                                        Tổng Tiền:
                                                                        <strong>{{ number_format($bien_1['tong_tien_thanh_toan'], 0, '.', ',') }}</strong>
                                                                    </h3>
                                                                </td>
                                                            </tr>
                                                        </table>
